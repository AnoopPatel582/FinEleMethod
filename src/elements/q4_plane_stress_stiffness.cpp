...
math::DenseMatrix q4_plane_stress_stiffness_matrix(const model::Q4Element &element,
                                                   ...
                                                   const model::MaterialCollection &materials)
{
    ...
    return q4_plane_stress_stiffness_matrix(coordinates, material, element.thickness());
}
} // namespace finelemethod::elements
