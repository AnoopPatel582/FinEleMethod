...
{
std::vector<Q4ElementPlaneStrainResults> recover_q4_plane_strain_model_results(
    ...
    const math::DenseVector &global_displacements)
{
    ...
    std::vector<Q4ElementPlaneStrainResults> model_results;
    ...
    for (const model::Q4Element &element : elements.elements())
    {
        ...
        model_results.push_back(Q4ElementPlaneStrainResults{
            element.id(),
            elements::recover_q4_plane_strain_gauss_results(
