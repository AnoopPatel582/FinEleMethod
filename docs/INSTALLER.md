...
FinEleMethod 0.2.0 uses an Inno Setup per-machine x64 installer. It installs
...
environment, checks that the application version is 0.2.0, verifies the
...
6. In **Help -> About FinEleMethod**, confirm version 0.2.0, Release, and 64-bit.
